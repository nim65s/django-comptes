    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        related_name="dettes", to=settings.AUTH_USER_MODEL
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "couples_membres",
                    models.ManyToManyField(to="comptes.Couple", blank=True),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "occasion",
                    models.ForeignKey(
                        on_delete=models.CASCADE, to="comptes.Occasion", null=True
                    ),
                ),
            ],
            options={
